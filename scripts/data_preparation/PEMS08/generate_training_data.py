...
def get_adjacency_matrix(distance_df, num_sensors=170, normalized_k=0.1):
...
def generate_data(args: argparse.Namespace):
    ...
    # Fixed dataset split for PEMS08
    test_num_short = 3566
...
if __name__ == "__main__":
    ...
    GRAPH_FILE_PATH = os.path.join(SCRIPT_DIR, "datasets/raw_data/{0}/PEMS08.csv".format(DATASET_NAME))
